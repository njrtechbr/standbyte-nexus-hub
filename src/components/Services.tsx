...
import { Server, Shield, Settings, Headphones, Cloud, Zap, Brain, Rocket } from "lucide-react";
...
const Services = () => {
  const services = [
    ...
    },
    {
      ...
      description: "Proteção de dados de próxima geração com criptografia quântica.",
    ...
    {
      icon: Headphones,
      title: "Suporte Preditivo",
      description: "Atendimento 24/7 com IA preditiva e resolução proativa.",
      ...
      <div className="relative z-10 container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center max-w-4xl mx-auto mb-20 animate-slide-in-up">
          ...
          <h2 className="text-5xl font-bold mb-6">
            ...
            <br />
            <span className="text-shimmer">Transformam o Futuro</span>
          </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {services.map((service, index) => (
            <div
              key={index}
              className="group relative p-8 rounded-2xl bg-white/80 backdrop-blur-sm border border-white/50 hover:border-transparent hover:shadow-2xl transition-all duration-500 animate-fade-in-scale hover-lift"
            ...
            >
              ...
              <div className="absolute inset-[2px] rounded-2xl bg-white/95 group-hover:bg-white transition-colors duration-500"></div>
              
              <div className="relative z-10">
                <div className={`w-16 h-16 rounded-xl bg-gradient-to-r ${service.gradient} flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-300 animate-rotate-in`}>
                ...
                <div className="mt-6 flex items-center text-transparent group-hover:text-blue-600 transition-colors duration-300">
                  ...
                  <ArrowRight className="w-4 h-4 transform translate-x-0 group-hover:translate-x-2 transition-transform duration-300" />
                </div>
              </div>
            </div>
          ))}
        ...
        <div className="text-center mt-16 animate-slide-in-up">
          <a
            href="#contact"
            className="inline-flex items-center px-8 py-4 bg-gradient-to-r from-blue-600 to-red-600 text-white font-semibold rounded-full hover:from-red-600 hover:to-blue-800 transition-all duration-300 animate-glow hover-lift"
          >
