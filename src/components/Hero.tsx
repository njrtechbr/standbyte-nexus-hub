...
const Hero = () => {
  return <section id="home" className="relative min-h-screen overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        <div className="absolute top-40 right-20 w-16 h-16 bg-purple-500 rounded-full opacity-15 animate-float animate-pulse" style={{
        animationDelay: '1s'
      }}></div>
        <div className="absolute bottom-40 left-20 w-24 h-24 bg-indigo-600 rounded-full opacity-20 animate-float" style={{
        animationDelay: '3s'
      }}></div>
        <div className="absolute top-60 right-40 w-12 h-12 bg-blue-400 rounded-full opacity-25 animate-bounce" style={{
        animationDelay: '2s'
      }}></div>
        <div className="absolute bottom-60 right-10 w-18 h-18 bg-purple-400 rounded-full opacity-20 animate-float" style={{
        animationDelay: '4s'
      }}></div>
        ...
        <div className="absolute top-1/2 right-1/4 w-24 h-px bg-gradient-to-r from-transparent via-purple-400 to-transparent opacity-25 animate-pulse" style={{
        animationDelay: '1.5s'
      }}></div>
      </div>
...
Certificada</span>
              ...
              <div className="flex flex-wrap gap-3 animate-fade-in-scale" style={{
              animationDelay: '0.8s'
            }}>
                {[{
                icon: Wifi,
                ...
                icon: Shield,
                text: "Segurança"
              }].map((service, index) => <div key={index} className="flex items-center px-3 py-2 rounded-full bg-white/10 backdrop-blur-sm border border-white/20 hover:bg-white/20 transition-all duration-300 hover:scale-105 animate-bounce" style={{
              ...
              <div className="flex flex-col sm:flex-row gap-6 animate-slide-in-up" style={{
              animationDelay: '1s'
            }}>
                <a href="#services" className="group relative inline-flex items-center justify-center px-8 py-4 font-semibold text-white rounded-full overflow-hidden hover:scale-110 transition-all duration-300 animate-pulse-custom" style={{
                ...
                <button className="group inline-flex items-center justify-center px-8 py-4 text-white font-semibold rounded-full border-2 border-white/30 glass-effect hover:bg-white/20 hover:scale-105 transition-all duration-300 animate-fade-in-scale" style={{
                animationDelay: '1.2s'
              }}>
              ...
              <div className="grid grid-cols-3 gap-8 pt-8">
                ...
                delay: "1.8s"
              }].map((stat, index) => <div key={index} className="text-center animate-fade-in-scale hover:scale-110 transition-transform duration-300" style={{
            ...
            <div className="relative animate-slide-in-right">
              <div className="relative z-10 glass-effect rounded-3xl p-8 hover:scale-105 transition-transform duration-500 animate-glow">
                <div className="space-y-6">
                  ...
                  <div className="flex items-center space-x-3 mb-6 animate-bounce" style={{
                  animationDelay: '2s'
                }}>
                    <div className="w-3 h-3 bg-blue-500 rounded-full animate-pulse"></div>
                    <div className="w-3 h-3 bg-purple-500 rounded-full animate-pulse" style={{
                    animationDelay: '0.2s'
                  }}></div>
                    <div className="w-3 h-3 bg-indigo-500 rounded-full animate-pulse" style={{
                    animationDelay: '0.4s'
                  }}></div>
                  </div>
                  
                  {/* Certificação Fluke highlight */}
                  <div className="bg-gradient-to-r from-blue-500/20 to-purple-500/20 p-4 rounded-xl border border-blue-400/30 animate-fade-in-scale" style={{
                  animationDelay: '2.2s'
                }}>
                  ...
                  <div className="space-y-4">
                    <div className="h-4 bg-gradient-to-r from-blue-400 to-purple-400 rounded animate-pulse animate-fade-in-scale" style={{
                    animationDelay: '2.4s'
                  }}></div>
                    <div className="h-4 bg-gradient-to-r from-purple-300 to-indigo-300 rounded w-3/4 animate-pulse animate-fade-in-scale" style={{
                    animationDelay: '2.6s'
                  }}></div>
                    <div className="h-4 bg-gradient-to-r from-indigo-200 to-blue-200 rounded w-1/2 animate-pulse animate-fade-in-scale" style={{
                    animationDelay: '2.8s'
                  }}></div>
                  </div>
                  ...
                  <div className="grid grid-cols-2 gap-4 mt-8">
                    ...
                    delay: "3.3s"
                  }].map((item, index) => <div key={index} className={`h-24 bg-gradient-to-br ${item.color} rounded-xl flex items-center justify-center hover:scale-110 hover:rotate-3 transition-all duration-300 animate-fade-in-scale animate-float`} style={{
              ...
              <div className="absolute top-1/2 -right-4 w-16 h-16 bg-gradient-to-br from-blue-400 to-purple-400 rounded-full opacity-25 animate-bounce" style={{
              animationDelay: '1s'
            }}></div>
            </div>
          </div>
