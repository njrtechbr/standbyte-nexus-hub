      ...
      <div className="relative z-10 container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-6xl mx-auto">
          {products.map((product, index) => (
            <div
              key={index}
              className="group relative overflow-hidden rounded-3xl glass-effect border border-white/10 hover:border-white/30 transition-all duration-300 hover:scale-105"
            >
              {/* Background gradient */}
              ...
              <div className="relative p-8">
                <div className="flex items-start justify-between mb-6">
                  <div className={`w-16 h-16 rounded-2xl bg-gradient-to-br ${product.gradient} flex items-center justify-center group-hover:scale-105 transition-transform duration-200`}>
                ...
                <h3 className="text-2xl font-bold text-white mb-4 group-hover:text-transparent group-hover:bg-clip-text group-hover:bg-gradient-to-r group-hover:from-blue-400 group-hover:to-gray-400 transition-all duration-300">
                  {product.title}
                </h3>
        ...
        <div className="text-center mt-16">
          <div className="inline-flex items-center space-x-4">
            <a
              href="#contact"
              className="px-8 py-4 bg-gradient-to-r from-blue-500 to-gray-600 text-white font-semibold rounded-full hover:from-gray-600 hover:to-blue-600 transition-all duration-300 hover:scale-105"
            >
